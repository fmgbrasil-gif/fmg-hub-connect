    ...
    <div className="w-full h-full">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground truncate">Departamento Fiscal</h1>
      ...
      <div className="w-full rounded-lg overflow-hidden" style={{ height: getIframeHeight() }}>
        <iframe 
          ...
          src="https://doc.clickup.com/9011841813/d/h/8cjbjrn-1391/5fe9145d907dd81" 
